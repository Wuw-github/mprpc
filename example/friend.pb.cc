...
PROTOBUF_NDEBUG_INLINE GetFriendListResponse::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    const ::fixbug::GetFriendListResponse& from_msg)
      : _has_bits_{from._has_bits_},
        _cached_size_{0},
        friend__{visibility, arena, from.friend__} {}
...
constexpr auto GetFriendListResponse::InternalNewImpl_() {
  constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
      PROTOBUF_FIELD_OFFSET(GetFriendListResponse, _impl_.friend__) +
          decltype(GetFriendListResponse::_impl_.friend__)::
...
GetFriendListResponse::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastBR1,
     {18, 63, 0, PROTOBUF_FIELD_OFFSET(GetFriendListResponse, _impl_.friend__)}},
    ...
    // repeated bytes friend = 2;
    {PROTOBUF_FIELD_OFFSET(GetFriendListResponse, _impl_.friend__), -1, 0,
...
::uint8_t* PROTOBUF_NONNULL GetFriendListResponse::_InternalSerialize(
  ...
  // repeated bytes friend = 2;
  for (int i = 0, n = this_._internal_friend__size(); i < n; ++i) {
    const auto& s = this_._internal_friend_().Get(i);
  ...
  ::_pbi::Prefetch5LinesFrom7Lines(&this_);
   {
    ...
    {
      total_size +=
          1 * ::google::protobuf::internal::FromIntSize(this_._internal_friend_().size());
      for (int i = 0, n = this_._internal_friend_().size(); i < n; ++i) {
        total_size += ::google::protobuf::internal::WireFormatLite::BytesSize(
            this_._internal_friend_().Get(i));
      }
    }
  }
   {
...
void GetFriendListResponse::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  _this->_internal_mutable_friend_()->MergeFrom(from._internal_friend_());
  cached_has_bits = from._impl_._has_bits_[0];
  if ((cached_has_bits & 0x00000001u) != 0) {
