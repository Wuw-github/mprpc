...
/* @@protoc_insertion_point(class_definition:fixbug.GetFriendListResponse) */ {
 ...
 public:
  ...
  ::std::string* PROTOBUF_NONNULL mutable_friend_(int index);
  template <typename Arg_ = const ::std::string&, typename... Args_>
  void set_friend_(int index, Arg_&& value, Args_... args);
  ::std::string* PROTOBUF_NONNULL add_friend_();
  template <typename Arg_ = const ::std::string&, typename... Args_>
  void add_friend_(Arg_&& value, Args_... args);
  const ::google::protobuf::RepeatedPtrField<::std::string>& friend_() const;
  ::google::protobuf::RepeatedPtrField<::std::string>* PROTOBUF_NONNULL mutable_friend_();

  private:
  const ::google::protobuf::RepeatedPtrField<::std::string>& _internal_friend_() const;
  ::google::protobuf::RepeatedPtrField<::std::string>* PROTOBUF_NONNULL _internal_mutable_friend_();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::internal::HasBits<1> _has_bits_;
    ::google::protobuf::internal::CachedSize _cached_size_;
    ::google::protobuf::RepeatedPtrField<::std::string> friend__;
...
inline ::std::string* PROTOBUF_NONNULL GetFriendListResponse::add_friend_()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::std::string* _s = _internal_mutable_friend_()->Add();
...
inline const ::std::string& GetFriendListResponse::friend_(int index) const
  ...
  return _internal_friend_().Get(index);
}
inline ::std::string* PROTOBUF_NONNULL GetFriendListResponse::mutable_friend_(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListResponse.friend)
  return _internal_mutable_friend_()->Mutable(index);
}
template <typename Arg_, typename... Args_>
inline void GetFriendListResponse::set_friend_(int index, Arg_&& value, Args_... args) {
  ::google::protobuf::internal::AssignToString(*_internal_mutable_friend_()->Mutable(index), ::std::forward<Arg_>(value),
                        args... , ::google::protobuf::internal::BytesTag{});
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListResponse.friend)
}
template <typename Arg_, typename... Args_>
inline void GetFriendListResponse::add_friend_(Arg_&& value, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::google::protobuf::internal::AddToRepeatedPtrField(*_internal_mutable_friend_(),
                               ::std::forward<Arg_>(value),
                               args... , ::google::protobuf::internal::BytesTag{});
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListResponse.friend)
}
inline const ::google::protobuf::RepeatedPtrField<::std::string>& GetFriendListResponse::friend_()
    const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListResponse.friend)
  return _internal_friend_();
}
inline ::google::protobuf::RepeatedPtrField<::std::string>* PROTOBUF_NONNULL
GetFriendListResponse::mutable_friend_() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListResponse.friend)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_friend_();
}
inline const ::google::protobuf::RepeatedPtrField<::std::string>&
GetFriendListResponse::_internal_friend_() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.friend__;
}
inline ::google::protobuf::RepeatedPtrField<::std::string>* PROTOBUF_NONNULL
GetFriendListResponse::_internal_mutable_friend_() {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return &_impl_.friend__;
}
